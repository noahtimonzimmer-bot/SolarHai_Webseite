...
// Scroll reveal — in dieser Fassung uebernimmt motion.js die Eintritte.
// Die Liste bleibt leer, damit sich beide Ebenen nicht dieselben Elemente teilen.
const revealTargets = document.querySelectorAll('[data-legacy-reveal]');
...
/* ================================================================
   ...
   ================================================================ */
(() => {
  // In dieser Fassung uebernehmen die View Transitions den Seitenwechsel.
  // Der alte Flug bleibt nur fuer Browser ohne diese Unterstuetzung.
